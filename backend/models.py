...
class Movie(db.Model):
    ...
    cast_movie = db.relationship(
        "CastMember", backref="movie", lazy=True, cascade="all, delete-orphan"
    )
...
class Actor(db.Model):
    ...
    cast_actor = db.relationship(
        "CastMember", backref="actors", lazy=True, cascade="all, delete-orphan"
    )
